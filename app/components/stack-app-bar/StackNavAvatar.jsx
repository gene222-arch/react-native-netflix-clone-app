...
const StackNavAvatar = () => 
{
    const navigation = useNavigation();

    const navigatoToAccountScreen = () => navigation.navigate('More');
    
    return (
        <TouchableOpacity onPress={ navigatoToAccountScreen }>
            <Avatar
                source={{
                    uri:
